<div class="iq-sidebar sidebar-default ">
    <div class="iq-sidebar-logo d-flex align-items-end justify-content-between">
        <a href="{{ route('dashboard.1') }}" class="header-logo">
            <img src="{{ asset('images/cevifa/LogoEmpresaPeq_Blanco.png') }}" class="img-fluid rounded-normal light-logo" alt="logo">
    ...
    <div class="data-scrollbar" data-scroll="1">
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="side-menu">
                <li class="{{activeRoute('dashboard1')}} sidebar-layout">
                ...
                <li class="{{activeRoute('customer')}} sidebar-layout">
                    <a href="{{route('customer')}}" class="svg-icon ">
                        <i class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <!-- <li class="{{activeRoute('product/product')}} sidebar-layout">
                    <a href="{{route('product.product')}}" class="svg-icon">
                        <i class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li class="{{activeRoute('order/order')}} sidebar-layout">
                    <a href="{{route('order.order')}}" class="svg-icon">
                        <i class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li class="{{activeRoute('invoice/invoice')}} sidebar-layout">
                    <a href="{{route('invoice.invoice')}}" class="svg-icon">
                        <i class="">
                ...
                <li class="{{activeRoute('app/todo')}} sidebar-layout">
                    <a href="{{route('app.todo')}}" class="svg-icon">
                        <i class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li class="{{activeRoute('calender')}} sidebar-layout">
                ...
                <li class="{{activeRoute('forms.generatePaymentLink')}} sidebar-layout">
                    <a href="{{route('forms.generatePaymentLink')}}" class="svg-icon">
                        <i class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                            </svg>
                        </i><span class="ml-2">Generar URL</span>
                    </a>
                </li>
                <!-- <li class="{{activeRoute('app/userdetail/userprofile')}} sidebar-layout">
                ...
                <li class="sidebar-layout">
                    ...
                    <ul id="app1" class="submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li class="{{activeRoute('auth/login')}} sidebar-layout">
                        ...
                        <li class="{{activeRoute('auth/register')}} sidebar-layout">
                        ...
                        <li class="{{activeRoute('auth/reset-password')}} sidebar-layout">
                            <a href="{{route('auth.reset-password')}}" class="svg-icon">
                                <i class="">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <li class="{{activeRoute('auth/verify-email')}} sidebar-layout">
                            <a href="{{route('auth.verify-email')}}" class="svg-icon">
                                <i class="">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <li class="{{activeRoute('auth/lock-screen')}} sidebar-layout">
                            <a href="{{route('auth.lock-screen')}}" class="svg-icon">
                                <i class="">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li class="sidebar-layout">
                    ...
                    <ul id="app6" class="submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li class="{{activeRoute('pageError/error404')}} sidebar-layout">
                        ...
                        <li class="{{activeRoute('pageError/error500')}} sidebar-layout">
                ...
                <li class="{{activeRoute('extrapages/comingsoon')}} sidebar-layout">
                    <a href="{{route('extrapages.comingsoon')}}" class="svg-icon">
                        <i class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li class="{{activeRoute('extrapages/maintenance')}} sidebar-layout">
                ...
                <li class="{{activeRoute('extrapages/blankpage')}} sidebar-layout">
                ...
                <li class="{{activeRoute('extrapages/faq')}} sidebar-layout">
                    <a href="{{route('extrapages.faq')}}" class="svg-icon">
                        <i class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li class="{{activeRoute('extrapages/pricing')}} sidebar-layout">
                ...
                <li class="{{activeRoute('timeline/timeline2')}} sidebar-layout">
                    <a href="{{route('timeline.timeline2')}}" class="svg-icon">
                        <i class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li class="sidebar-layout">
                    ...
                    <ul id="app2" class="submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li class="{{activeRoute('ui/avatars')}} sidebar-layout">
                        ...
                        <li class="{{activeRoute('ui/alerts')}} sidebar-layout">
                        ...
                        <li class="{{activeRoute('ui/badges')}} sidebar-layout">
                        ...
                        <li class="{{activeRoute('ui/breadcrumb')}} sidebar-layout">
                        ...
                        <li class="{{activeRoute('ui/buttons')}} sidebar-layout">
                        ...
                        <li class="{{activeRoute('ui/buttongroup')}} sidebar-layout">
                        ...
                        <li class="{{activeRoute('ui/boxshadows')}} sidebar-layout">
                        ...
                        <li class="{{activeRoute('ui/colors')}} sidebar-layout">
                        ...
                        <li class="{{activeRoute('ui/cards')}} sidebar-layout">
                        ...
                        <li class="{{activeRoute('ui/carousel')}} sidebar-layout">
                        ...
                        <li class="{{activeRoute('ui/grid')}} sidebar-layout">
                        ...
                        <li class="{{activeRoute('ui/images')}} sidebar-layout">
                        ...
                        <li class="{{activeRoute('ui/listgroup')}} sidebar-layout">
                        ...
                        <li class="{{activeRoute('ui/media')}} sidebar-layout">
                        ...
                        <li class="{{activeRoute('ui/modal')}} sidebar-layout">
                        ...
                        <li class="{{activeRoute('ui/notification')}} sidebar-layout">
                        ...
                        <li class="{{activeRoute('ui/pagination')}} sidebar-layout">
                        ...
                        <li class="{{activeRoute('ui/popovers')}} sidebar-layout">
                        ...
                        <li class="{{activeRoute('ui/progressbars')}} sidebar-layout">
                        ...
                        <li class="{{activeRoute('ui/typography')}} sidebar-layout">
                        ...
                        <li class="{{activeRoute('ui/tabs')}} sidebar-layout">
                        ...
                        <li class="{{activeRoute('ui/tooltips')}} sidebar-layout">
                        ...
                        <li class="{{activeRoute('ui/video')}} sidebar-layout">
                    ...
                    <ul id="app3" class="submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li class="sidebar-layout">
                            ...
                            <ul id="form1" class="submenu collapse" data-parent="#app3">
                                <li class="{{activeRoute('forms/layout')}} sidebar-layout">
                                    <a href="{{route('forms.layout')}}" class="svg-icon">
                                        <i class="">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <li class="{{activeRoute('forms/inputgroup')}} sidebar-layout">
                                ...
                                <li class="{{activeRoute('forms/validation')}} sidebar-layout">
                                ...
                                <li class="{{activeRoute('forms/switch')}} sidebar-layout">
                                ...
                                <li class="{{activeRoute('forms/checkbox')}} sidebar-layout">
                                ...
                                <li class="{{activeRoute('forms/radio')}} sidebar-layout">
                                ...
                                <li class="{{activeRoute('forms/textarea')}} sidebar-layout">
                        ...
                        <li class="sidebar-layout">
                            ...
                            <ul id="form2" class="submenu collapse" data-parent="#app3">
                                <li class="{{activeRoute('forms/datepicker')}} sidebar-layout">
                                    <a href="{{route('forms.datepicker')}}" class="svg-icon">
                                        <i class="">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                            </svg>
                                ...
                                <li class="{{activeRoute('forms/select')}} sidebar-layout">
                                    <a href="{{route('forms.select')}}" class="svg-icon">
                                        <i class="">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <li class="{{activeRoute('forms/fileuploader')}} sidebar-layout">
                                    <a href="{{route('forms.fileuploader')}}" class="svg-icon">
                                        <i class="">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <li class="{{activeRoute('forms/quill')}} sidebar-layout">
                                    <a href="{{route('forms.quill')}}" class="svg-icon">
                                        <i class="">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                            </svg>
                ...
                <li class="sidebar-layout">
                    ...
                    <ul id="app5" class="submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li class="{{activeRoute('table/tablebasics')}}" class="sidebar-layout">
                        ...
                        <li class="{{activeRoute('table/tabledata')}} sidebar-layout">
                        ...
                        <li class="{{activeRoute('table/tableeditable')}} sidebar-layout">
                            <a href="{{route('table.tableeditable')}}" class="svg-icon">
                                <i class="">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li class="{{activeRoute('chart/apex')}} sidebar-layout">
                    <a href="{{route('chart.apex')}}" class="svg-icon">
                        <i class="">
                ...
                <li class="{{activeRoute('icons/heroicons')}}" class="sidebar-layout">
                    <a href="{{route('icons.heroicons')}}" class="svg-icon">
                        <i class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
