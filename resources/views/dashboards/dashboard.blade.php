    ...
    <div class="container-fluid">
        <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="">
                                        <p class="mb-2 text-secondary">Total Pagado</p>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="">
                                        <p class="mb-2 text-secondary">Total Declinado</p>
                                        <div class="d-flex flex-wrap justify-content-start align-items-center">
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="">
                                        <p class="mb-2 text-secondary">Total Pendiente</p>
                                        <div class="d-flex flex-wrap justify-content-start align-items-center">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center flex-wrap">
                                    <h4 class="font-weight-bold">Reporte de pagos</h4>
                    ...
                    <div class="card-body-list">
                        <ul class="list-style-3 mb-0">
                            <li class="p-3 list-item d-flex justify-content-start align-items-center">
                                <div class="avatar">
                                    <img class="avatar avatar-img avatar-60 rounded" src="{{asset('images/products/1.jpg')}}">
                                </div>
                            ...
                            <li class="p-3 list-item d-flex justify-content-start align-items-center">
                                <div class="avatar">
                                    <img class="avatar avatar-img avatar-60 rounded" src="{{asset('images/products/2.jpg')}}">
                                </div>
                                <div class="list-style-detail ml-3 mr-2">
                            ...
                            <li class="p-3 list-item d-flex justify-content-start align-items-center">
                                <div class="avatar">
                                    <img class="avatar avatar-img avatar-60 rounded" src="{{asset('images/products/13.jpg')}}">
                                </div>
                                <div class="list-style-detail ml-3 mr-2">
                            ...
                            <li class="p-3 list-item d-flex justify-content-start align-items-center">
                                <div class="avatar">
                                    <img class="avatar avatar-img avatar-60 rounded" src="{{asset('images/products/14.jpg')}}">
                                </div>
                                <div class="list-style-detail ml-3 mr-2">
            ...
            <!-- <div class="col-lg-4 col-md-6">
                <div class="card">
                    <div class="card-body">
                        <h4 class="font-weight-bold mb-3">Pagos por agentes</h4>
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-45 mr-2">
                                                    <img src="{{asset('images/user/2.jpg')}}" class="img-fluid rounded-circle" alt="image">
                                                </div>
                                    ...
                                    <tr class="white-space-no-wrap">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-45 mr-2">
                                                    <img src="{{asset('images/user/5.jpg')}}" class="img-fluid rounded-circle" alt="image">
                                                </div>
                                    ...
                                    <tr class="white-space-no-wrap">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-45 mr-2">
                                                    <img src="{{asset('images/user/1.jpg')}}" class="img-fluid rounded-circle" alt="image">
                                                </div>
                                                <div>Max Lynn</div>
                                            </div>
                                        </td>
                                    ...
                                    <tr class="white-space-no-wrap">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-45 mr-2">
                                                    <img src="{{asset('images/user/3.jpg')}}" class="img-fluid rounded-circle" alt="image">
                                                </div>
                                                <div>Danniw Yatt</div>
                                            </div>
                                        </td>
                ...
                <div class="card-body">
                    ...
                    <table id="datatable" class="table data-table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <!-- cololar un numero que se autoincremente -->
                                <td>{{ $i++ }}</td>
                                <td>{{ $payment->TX_PrimerNombre }} {{ $payment->TX_PrimerApellido }}</td>
                                <td>{{ $payment->TX_TelefonoCelular }}</td>
                                <td>{{ $payment->ProfecinalPrimerNombre }} {{ $payment->ProfecinalPrimerApellido }}</td>
                                <td>{{ $payment->DT_FechaDesdeCita }}</td>
